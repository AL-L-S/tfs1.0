...
#define NETWORKMSG_MAXSIZE 24590
...
enum SpeakClasses : uint8_t {
	...
	SPEAK_WHISPER		= 0x02,
	SPEAK_YELL		= 0x03,
	SPEAK_PRIVATE_FROM	= 0x06,
	SPEAK_PRIVATE_TO	= SPEAK_PRIVATE_FROM,
	...
	SPEAK_PRIVATE_RED_TO	= SPEAK_PRIVATE_RED_FROM, //@name@text
	SPEAK_MONSTER_SAY	= 0x13,
	SPEAK_MONSTER_YELL	= 0x14,

	SPEAK_CHANNEL_R2	= 0x11, //#d
	SPEAK_CHANNEL_W		= 0x08
};

enum MessageClasses : uint8_t {
	MSG_HIDDEN					= 0xFF,
	MSG_STATUS_CONSOLE_BLUE		= 0x1B, /*FIXME Blue message in the console*/
	MSG_STATUS_CONSOLE_RED		= 0x12, /*Red message in the console*/
